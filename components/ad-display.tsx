      ...
      <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid var(--line)" }}>
        <a href={trackUrl(ad)} target="_blank" rel="noreferrer sponsored" className="block">
          {ad.image_url
            ...
            : <div className="w-full aspect-[3/1] grid place-items-center px-4 text-center font-semibold text-sm" style={{ background: "var(--sand)", color: "var(--ink)" }}>{ad.title}</div>
          }
        </a>
        <div className="px-3 py-1.5 flex items-center justify-between" style={{ background: "#fff" }}>
          <span className="text-[11px]" style={{ color: "var(--ink-soft)" }}>{ad.company_name}</span>
          <span className="text-[10px] uppercase tracking-wide" style={{ color: "var(--ink-soft)" }}>Parceiro</span>
        </div>
      </div>
    );
  }
    ...
    <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid var(--line)" }}>
      <a href={trackUrl(ad)} target="_blank" rel="noreferrer sponsored" className="block">
        {ad.image_url
          ...
          : <div className="w-full aspect-[5/1] grid place-items-center px-6 text-lg font-semibold text-center" style={{ background: "var(--sand)", color: "var(--ink)" }}>{ad.title}</div>
        }
      </a>
      <div className="px-4 py-2 flex items-center justify-between" style={{ background: "#fff" }}>
        ...
        <span className="text-[11px] uppercase tracking-wide" style={{ color: "var(--ink-soft)" }}>Publicidade</span>
      </div>
    </div>
  );
}
