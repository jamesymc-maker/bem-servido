...
export async function AdSlot({ labelKey, categorySlug }: { labelKey: "home" | "category"; categorySlug?: string }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-5 my-10">
      {ad ? <AdCard ad={ad} size="banner" /> : <AdPlaceholder label={labelKey === "home" ? "Página inicial" : "Categoria"} />}
    </div>
  );
}
