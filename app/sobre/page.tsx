...
const title = "Sobre · Bem Servido · Serviços locais de confiança em Ilhabela";
const description =
  "O Bem Servido conecta você aos melhores profissionais locais de Ilhabela. Saiba como funciona e tire suas dúvidas.";

export const metadata: Metadata = {
  title,
  description,
  alternates: { canonical: "/sobre" },
  openGraph: openGraphMetadata({ title, description, url: "/sobre" }),
};
