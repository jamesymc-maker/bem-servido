...
export default async function PlanoPage() {
  ...
  return (
    <div>
      <h1 className="serif text-2xl mb-1" style={{ fontWeight: 600 }}>Plano</h1>
      <p className="text-sm mb-6" style={{ color: "var(--ink-soft)" }}>Escolha o plano que dá mais visibilidade ao seu perfil.</p>
